...
//LED - TIMER1
#define prescaler_led				799
#define resolution				100 // T_period / timer_clk = 10ms / 0.1ms
#define timer_clk_led				0.1
uint16_t counter_period_led = resolution - 1;
uint16_t duty_cycle_led = 0;
uint32_t adc_led = 0;

//SERVO - TIMER2
#define prescaler_servo			79
#define timer_clk_servo			0.01     // ms per pulse
#define SERVO_PERIOD 			2000     // T_servo / timer_clk_servo = 20ms / 0.01 ms
uint16_t neg90_angle			50
uint16_t pos90_angle			250
uint16_t counter_period_servo = SERVO_PERIOD - 1;
uint16_t duty_cycle_servo = 50; // initial angle
uint32_t adc_servo = 0;
...
static void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = prescaler_led;
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = counter_period_led;
...
static void MX_TIM2_Init(void)
{
  ...
  htim2.Instance = TIM2;
  htim2.Init.Prescaler = prescaler_servo;
  htim2.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim2.Init.Period = counter_period_servo;
