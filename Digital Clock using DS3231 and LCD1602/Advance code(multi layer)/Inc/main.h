...
/* Private defines -----------------------------------------------------------*/
#define WRITE_FLASH_Pin GPIO_PIN_15
#define WRITE_FLASH_GPIO_Port GPIOB
#define WRITE_FLASH_EXTI_IRQn EXTI15_10_IRQn
...
#define CURSOR_MOVE_Pin GPIO_PIN_11
#define CURSOR_MOVE_GPIO_Port GPIOA
#define CURSOR_MOVE_EXTI_IRQn EXTI15_10_IRQn
